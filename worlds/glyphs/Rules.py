...
def set_rules(world: "GlyphsWorld"):
    ...
    if world.options.ButtonSanity.value:
        ...
        set_button_rule(world, "Between rm1",           lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm1"])                                                                         and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm4",           lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm4"])                                                                         and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm5",           lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm5"])                                                                         and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm10",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm10"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm13",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm13"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm19",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm19"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm28",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm28"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm30",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm30"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm39",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm39"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm40",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm40"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm42 Button 1", lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm42 Button 1"])                                                               and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm42 Button 2", lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm42 Button 2"])                                                               and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm42 Button 3", lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm42 Button 3"])                                                               and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm42 Button 4", lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm42 Button 4"])                                                               and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm42 Button 5", lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm42 Button 5"])                                                               and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm42 Button 6", lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm42 Button 6"])                                                               and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm42 Button 7", lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm42 Button 7"])                                                               and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm43 Button 1", lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm43 Button 1"])                                                               and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm43 Button 2", lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm43 Button 2"])                                                               and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm57",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm57"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm66",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm66"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between rm71",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm71"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
        set_button_rule(world, "Between Pre-Boss 1",    lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between Pre-Boss 1"])                                                                  and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 8))
