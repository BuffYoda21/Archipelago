...
def connect_entrances(world: "GlyphsWorld"):
    ...
    connect_areas(world, "Region 2B",       "Region 2L",            lambda state: True)
  ...
  # connect_areas(world, "Region 2E",       "Region 2B",            lambda state: True) # this actually doesnt work since the path is blocked off from this angle if you havn't visited the region before
    ...
    connect_areas(world, "Region 2G",       "Region 2F",            lambda state: can_dash(state, player)                           and can_press_buttons(state, world, ["R2G Hidden"]))
  ...
  # connect_areas(world, "Region 2J",       "Region 2I",            lambda state: can_chain_wall_jumps(state, player, world))   # logically will never be needed without save button sanity
    ...
    connect_areas(world, "Region 2P",       "Region 2O",            lambda state: defeated_gilded_serpent(state, player)            and can_dash(state, player))
    connect_areas(world, "Region 2P",       "Region 2Q",            lambda state: has_grapple(state, player)                        and can_press_buttons(state, world, ["R2P Left"]))
  ...
  # connect_areas(world, "Region 4C",       "Region 4D",            lambda state: can_dash(state, player)                           and has_grapple(state, player)       and (get_button_color(world, "R4C 4th") != ButtonColor.PINK or can_press_buttons(state, world, ["R4C 3rd"])) and (get_button_color(world, "R4C 5th") == ButtonColor.GREEN or can_press_buttons(state, world, ["R4C 6th"])) and (get_button_color(world, "R4C 9th") != ButtonColor.PINK or can_press_buttons(state, world, ["R4C 10th"])) and can_press_buttons(state, world, ["R4C 1st", "R4C 2nd", "R4C 4th", "R4C 5th", "R4C 7th", "R4C 8th", "R4C 9th", "R4C 5 Parry 1", "R4C 5 Parry 2", "R4C 5 Parry 3", "R4C 5 Parry 4", "R4C 5 Parry 5", "R4C Gate Right"]))
    ...
    connect_areas(world, "Region 4I",       "Region 4J",            lambda state: can_dash(state, player)                           and can_press_buttons(state, world, ["R4I Left", "R4I Right", "R4I Gate Upper"]))
    connect_areas(world, "Smile Shop",      "Region 1C",            lambda state: True)
    connect_areas(world, "Dark Region A",   "Dark Region B",        lambda state: can_dash(state, player)                           and has_grapple(state, player)       and defeated_null(state, player)    and can_press_buttons(state, world, ["Dark 1", "Dark 2", "Dark 3", "Dark 4", "Dark 5", "Dark 6", "Dark Save"]))
    connect_areas(world, "The Between",     "Region 2B",            lambda state: can_dash(state, player))
    if world.options.LogicalWallJumps.value:
        connect_areas(world, "The Between", "Smile Shop",           lambda state: can_dash(state, player))
    else:
        connect_areas(world, "The Between", "Smile Shop",           lambda state: can_dash(state, player)                           and has_grapple(state, player))
    ...
    connect_areas(world, "Act 1",           "Epilogue",             lambda state: can_dash(state, player)                           and has_grapple(state, player)       and state.has("Shroud", player)     and can_press_buttons(state, world, ["Epilogue 1"]))
...
def set_rules(world: "GlyphsWorld"):
    ...
    if world.options.ButtonSanity.value:
        set_button_rule(world, "R1A Save",              lambda state: can_press_buttons(state, world, ["R1A Save"]))
        set_button_rule(world, "R1B Lowest",            lambda state: can_press_buttons(state, world, ["R1B Lowest"]))
        set_button_rule(world, "R1B 2nd Lowest",        lambda state: can_press_buttons(state, world, ["R1B Lowest", "R1B 2nd Lowest"])                                                                             and can_dash(state, player))
        set_button_rule(world, "R1B 3rd Lowest",        lambda state: can_press_buttons(state, world, ["R1B Lowest", "R1B 3rd Lowest"])                                                                             and can_dash(state, player))
        ...
        set_button_rule(world, "R1F Right",             lambda state: can_press_buttons(state, world, ["R1F Right"])                                                                                                and can_dash(state, player))
        set_button_rule(world, "R2A Gate Left",         lambda state: can_press_buttons(state, world, ["R2A Gate Left"])                                                                                            and can_dash(state, player))
        set_button_rule(world, "R2A Gate Right",        lambda state: can_press_buttons(state, world, ["R2A Gate Left", "R2A Gate Right"])                                                                          and can_dash(state, player))
        set_button_rule(world, "R2A Left Save",         lambda state: can_press_buttons(state, world, ["R2A Left Save"]))
        set_button_rule(world, "R2A Right Save",        lambda state: can_press_buttons(state, world, ["R2A Gate Left", "R2A Right Save"])                                                                          and can_dash(state, player))
        set_button_rule(world, "R2A Upper",             lambda state: can_press_buttons(state, world, ["R2A Gate Left", "R2A Upper"])                                                                               and can_dash(state, player))
        set_button_rule(world, "R2B Puzzle",            lambda state: can_press_buttons(state, world, ["R2B Puzzle"])                                                                                               and can_dash(state, player))
        set_button_rule(world, "R2B Gate Left",         lambda state: can_press_buttons(state, world, ["R2B Gate Left"])                                                                                            and can_dash(state, player))
        set_button_rule(world, "R2B Left Save",         lambda state: can_press_buttons(state, world, ["R2B Left Save"]))
        set_button_rule(world, "R2B Right Save",        lambda state: can_press_buttons(state, world, ["R2B Right Save"]))
        set_button_rule(world, "R2D Save",              lambda state: can_press_buttons(state, world, ["R2D Save"]))
        set_button_rule(world, "R2E Lower Save",        lambda state: can_press_buttons(state, world, ["R2E Lower Save"]))
        set_button_rule(world, "R2E Upper Save",        lambda state: can_press_buttons(state, world, ["R2E Upper Save", "R2E Lower"])                                                                              and can_dash(state, player))
        set_button_rule(world, "R2E Lower",             lambda state: can_press_buttons(state, world, ["R2E Lower"])                                                                                                and can_dash(state, player))
        set_button_rule(world, "R2E Upper",             lambda state: can_press_buttons(state, world, ["R2E Upper", "R2E Lower"])                                                                                   and can_dash(state, player))
        set_button_rule(world, "R2E Upper Puzzle",      lambda state: can_press_buttons(state, world, ["R2E Upper Puzzle", "R2E Lower"])                                                                            and can_dash(state, player))
        set_button_rule(world, "R2E Serpent Lock 1",    lambda state: can_press_buttons(state, world, ["R2E Lower", "R2E Upper", "R2E Serpent Lock 1"])                                                             and can_dash(state, player))
        set_button_rule(world, "R2F Save",              lambda state: can_press_buttons(state, world, ["R2F Save"]))
        set_button_rule(world, "R2G Lower",             lambda state: can_press_buttons(state, world, ["R2G Lower"])                                                                                                and can_dash(state, player))
        set_button_rule(world, "R2G Middle",            lambda state: can_press_buttons(state, world, ["R2G Lower", "R2G Middle"])                                                                                  and can_dash(state, player))
        set_button_rule(world, "R2G Moving Platform",   lambda state: can_press_buttons(state, world, ["R2G Lower", "R2G Moving Platform"])                                                                         and can_dash(state, player))
        set_button_rule(world, "R2G Upper Left",        lambda state: can_press_buttons(state, world, ["R2G Lower", "R2G Middle", "R2G Upper Middle", "R2G Upper Left"])                                            and can_dash(state, player))
        set_button_rule(world, "R2G Upper Middle",      lambda state: can_press_buttons(state, world, ["R2G Lower", "R2G Middle", "R2G Upper Middle"])                                                              and can_dash(state, player))
        set_button_rule(world, "R2G Upper Right",       lambda state: can_press_buttons(state, world, ["R2G Lower", "R2G Middle", "R2G Upper Right"])                                                               and can_dash(state, player) and (can_parry(state, player) or can_press_buttons(state, world, ["R2G Upper Middle", "R2G Upper Left"])))
        set_button_rule(world, "R2G Hidden",            lambda state: can_press_buttons(state, world, ["R2G Hidden"])                                                                                               and can_dash(state, player))
        set_button_rule(world, "R2H Save",              lambda state: can_press_buttons(state, world, ["R2H Save"]))
        set_button_rule(world, "R2H Lower",             lambda state: can_press_buttons(state, world, ["R2H Lower"])                                                                                                and can_dash(state, player))
        set_button_rule(world, "R2H Serpent Lock 2",    lambda state: can_press_buttons(state, world, ["R2H Serpent Lock 2"])                                                                                       and can_dash(state, player))
        set_button_rule(world, "R2I Lower Left",        lambda state: can_press_buttons(state, world, ["R2I Lower Left"]))
        set_button_rule(world, "R2I Lower Middle",      lambda state: can_press_buttons(state, world, ["R2I Lower Middle"]))
        set_button_rule(world, "R2I Upper Left",        lambda state: can_press_buttons(state, world, ["R2I Upper Left", "R2I Upper Middle", "R2I Lower Left", "R2I Lower Middle", "R2I Right"])                    and can_dash(state, player))
        set_button_rule(world, "R2I Upper Middle",      lambda state: can_press_buttons(state, world, ["R2I Upper Middle", "R2I Lower Left", "R2I Lower Middle"])                                                   and can_dash(state, player))
        set_button_rule(world, "R2I Right",             lambda state: can_press_buttons(state, world, ["R2I Right"])                                                                                                and can_dash(state, player))
        set_button_rule(world, "R2I Save",              lambda state: can_press_buttons(state, world, ["R2I Save"]))
        set_button_rule(world, "R2J Gate Left",         lambda state: can_press_buttons(state, world, ["R2J Gate Left"])                                                                                            and can_dash(state, player))
        set_button_rule(world, "R2J Save",              lambda state: can_press_buttons(state, world, ["R2J Save"]))
        set_button_rule(world, "R2K Chase 1",           lambda state: can_press_buttons(state, world, ["R2K Chase 1"])                                                                                              and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chase 2",           lambda state: can_press_buttons(state, world, ["R2K Chase 1", "R2K Chase 2"])                                                                               and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chase 3",           lambda state: can_press_buttons(state, world, ["R2K Chase 1", "R2K Chase 2", "R2K Chase 3"])                                                                and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chase 4",           lambda state: can_press_buttons(state, world, ["R2K Chase 1", "R2K Chase 2", "R2K Chase 3", "R2K Chase 4"])                                                 and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chase 5",           lambda state: can_press_buttons(state, world, ["R2K Chase 1", "R2K Chase 2", "R2K Chase 3", "R2K Chase 4", "R2K Chase 5"])                                  and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chase 6",           lambda state: can_press_buttons(state, world, ["R2K Chase 1", "R2K Chase 2", "R2K Chase 3", "R2K Chase 4", "R2K Chase 5", "R2K Chase 6"])                   and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chase Hidden",      lambda state: can_press_buttons(state, world, ["R2K Chase Hidden"])                                                                                         and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chaos Upper 1",     lambda state: can_press_buttons(state, world, ["R2K Chase Hidden", "R2K Chaos Upper 1", "R2K Chaos Upper 2"])                                               and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chaos Upper 2",     lambda state: can_press_buttons(state, world, ["R2K Chase Hidden", "R2K Chaos Upper 2"])                                                                    and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chaos Upper 3",     lambda state: can_press_buttons(state, world, ["R2K Chase Hidden", "R2K Chaos Upper 3"])                                                                    and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chaos Upper 4",     lambda state: can_press_buttons(state, world, ["R2K Chase Hidden", "R2K Chaos Upper 4"])                                                                    and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chaos Middle 1",    lambda state: can_press_buttons(state, world, ["R2K Chase Hidden", "R2K Chaos Middle 1"])                                                                   and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chaos Middle 2",    lambda state: can_press_buttons(state, world, ["R2K Chase Hidden", "R2K Chaos Middle 2"])                                                                   and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chaos Middle 3",    lambda state: can_press_buttons(state, world, ["R2K Chase Hidden", "R2K Chaos Middle 3"])                                                                   and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chaos Middle 4",    lambda state: can_press_buttons(state, world, ["R2K Chase Hidden", "R2K Chaos Middle 4"])                                                                   and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chaos Middle 5",    lambda state: can_press_buttons(state, world, ["R2K Chase Hidden", "R2K Chaos Middle 5"])                                                                   and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chaos Lower 1",     lambda state: can_press_buttons(state, world, ["R2K Chase Hidden", "R2K Chaos Lower 1"])                                                                    and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chaos Lower 2",     lambda state: can_press_buttons(state, world, ["R2K Chase Hidden", "R2K Chaos Lower 2"])                                                                    and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chaos Lower 3",     lambda state: can_press_buttons(state, world, ["R2K Chase Hidden", "R2K Chaos Lower 3"])                                                                    and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chaos Lower 4",     lambda state: can_press_buttons(state, world, ["R2K Chase Hidden", "R2K Chaos Lower 4"])                                                                    and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chaos Lower 5",     lambda state: can_press_buttons(state, world, ["R2K Chase Hidden", "R2K Chaos Lower 5"])                                                                    and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chaos Lower 6",     lambda state: can_press_buttons(state, world, ["R2K Chase Hidden", "R2K Chaos Lower 6"])                                                                    and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chaos Pivot 1",     lambda state: can_press_buttons(state, world, ["R2K Chase Hidden", "R2K Chaos Pivot 1"])                                                                    and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chaos Pivot 2",     lambda state: can_press_buttons(state, world, ["R2K Chase Hidden", "R2K Chaos Pivot 2"])                                                                    and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2K Chaos Sliding Platform", lambda state: can_press_buttons(state, world, ["R2K Chase Hidden", "R2K Chaos Sliding Platform"])                                                      and can_dash(state, player) and has_grapple(state, player))
        ...
        set_button_rule(world, "R2N Chase 2",           lambda state: can_press_buttons(state, world, ["R2N Chase 1", "R2N Chase 2"])                                                                               and can_dash(state, player) and can_fight(state, world))
        set_button_rule(world, "R2P Left",              lambda state: can_press_buttons(state, world, ["R2P Left"])                                                                                                 and has_grapple(state, player))
        set_button_rule(world, "R2P Puzzle",            lambda state: can_press_buttons(state, world, ["R2P Puzzle"])                                                                                               and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R2P Save",              lambda state: can_press_buttons(state, world, ["R2P Save"]))
        set_button_rule(world, "R2Q Save",              lambda state: can_press_buttons(state, world, ["R2Q Save"]))
        set_button_rule(world, "R3A Mirror Green",      lambda state: can_press_buttons(state, world, ["R3A Mirror Green"])                                                                                         and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R3A Mirror Blue",       lambda state: can_press_buttons(state, world, ["R3A Mirror Green", "R3A Mirror Blue"])                                                                      and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R3A Left",              lambda state: can_press_buttons(state, world, ["R3A Left"])                                                                                                 and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R3A Middle Upper",      lambda state: can_press_buttons(state, world, ["R3A Middle Upper"]))
        set_button_rule(world, "R3A Middle Lower",      lambda state: can_press_buttons(state, world, ["R3A Middle Lower", "R3A Middle Upper"])                                                                     and can_dash(state, player))
        set_button_rule(world, "R3A Save",              lambda state: can_press_buttons(state, world, ["R3A Save"]))
        set_button_rule(world, "R3B Save",              lambda state: can_press_buttons(state, world, ["R3B Save"]))
        set_button_rule(world, "R3C Left",              lambda state: can_press_buttons(state, world, ["R3C Left"])                                                                                                 and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R3C Middle",            lambda state: can_press_buttons(state, world, ["R3C Middle"])                                                                                               and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R3C Right",             lambda state: can_press_buttons(state, world, ["R3C Right"])                                                                                                and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R3C Gate Right",        lambda state: can_press_buttons(state, world, ["R3C Gate Right"])                                                                                           and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R3C Save",              lambda state: can_press_buttons(state, world, ["R3C Save"]))
        set_button_rule(world, "R3D Upper",             lambda state: can_press_buttons(state, world, ["R3D Upper"])                                                                                                and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R3D Lower",             lambda state: can_press_buttons(state, world, ["R3D Upper", "R3D Lower", "R3D Gate Upper"])                                                                 and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R3D Gate Upper",        lambda state: can_press_buttons(state, world, ["R3D Gate Upper"])                                                                                           and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R3D Save",              lambda state: can_press_buttons(state, world, ["R3D Save"]))
        set_button_rule(world, "R3E Upper",             lambda state: can_press_buttons(state, world, ["R3E Upper"])                                                                                                and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R3E Puzzle",            lambda state: can_press_buttons(state, world, ["R3E Upper", "R3E Puzzle"])                                                                                  and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R3E QR Upper Left",     lambda state: can_press_buttons(state, world, ["R3E QR Upper Left"])                                                                                        and can_dash(state, player))
        set_button_rule(world, "R3E QR Upper Right",    lambda state: can_press_buttons(state, world, ["R3E QR Upper Right"])                                                                                       and can_dash(state, player))
        set_button_rule(world, "R3E QR Lower Left",     lambda state: can_press_buttons(state, world, ["R3E QR Lower Left"])                                                                                        and can_dash(state, player))
        set_button_rule(world, "R3E QR Lower Right",    lambda state: can_press_buttons(state, world, ["R3E QR Lower Right"])                                                                                       and can_dash(state, player))
        set_button_rule(world, "R3E Lower Room 1",      lambda state: can_press_buttons(state, world, ["R3E Upper", "R3E Lower Room 1"])                                                                            and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R3E Lower Room 2",      lambda state: can_press_buttons(state, world, ["R3E Upper", "R3E Lower Room 2"])                                                                            and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R3E Lower Room 3",      lambda state: can_press_buttons(state, world, ["R3E Upper", "R3E Lower Room 3"])                                                                            and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R3E Gate Upper",        lambda state: can_press_buttons(state, world, ["R3E Upper", "R3E Gate Upper"])                                                                              and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R3E Save",              lambda state: can_press_buttons(state, world, ["R3E Save"]))
        ...
        set_button_rule(world, "R3I Challenge 3",       lambda state: can_press_buttons(state, world, ["R3I Challenge 1", "R3I Challenge 2", "R3I Challenge 3"])                                                    and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R3I Challenge 4",       lambda state: can_press_buttons(state, world, ["R3I Challenge 1", "R3I Challenge 2", "R3I Challenge 4"])                                                    and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R3I Save",              lambda state: can_press_buttons(state, world, ["R3I Save"]))
        set_button_rule(world, "R4A Left",              lambda state: can_press_buttons(state, world, ["R4A Left", "R4A Middle", "R4A Right"])                                                                      and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R4A Middle",            lambda state: can_press_buttons(state, world, ["R4A Middle", "R4A Right"])                                                                                  and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "R4A Right",             lambda state: can_press_buttons(state, world, ["R4A Right"])                                                                                                and can_dash(state, player))
        set_button_rule(world, "R4B Save",              lambda state: can_press_buttons(state, world, ["R4B Save"]))
        ...
        set_button_rule(world, "R4C 7th",               lambda state: can_press_buttons(state, world, ["R4C 1st", "R4C 2nd", "R4C 4th", "R4C 5th", "R4C 7th"])                                                      and can_dash(state, player) and has_grapple(state, player) and (get_button_color(world, "R4C 4th") != ButtonColor.PINK or can_press_buttons(state, world, ["R4C 3rd"])) and ((get_button_color(world, "R4C 5th") == ButtonColor.GREEN and has_sword(state, player)) or can_press_buttons(state, world, ["R4C 6th"])))
        set_button_rule(world, "R4C 8th",               lambda state: can_press_buttons(state, world, ["R4C 1st", "R4C 2nd", "R4C 4th", "R4C 5th", "R4C 8th"])                                                      and can_dash(state, player) and has_grapple(state, player) and (get_button_color(world, "R4C 4th") != ButtonColor.PINK or can_press_buttons(state, world, ["R4C 3rd"])) and ((get_button_color(world, "R4C 5th") == ButtonColor.GREEN and has_sword(state, player)) or can_press_buttons(state, world, ["R4C 6th"])))
        set_button_rule(world, "R4C 9th",               lambda state: can_press_buttons(state, world, ["R4C 1st", "R4C 2nd", "R4C 4th", "R4C 5th", "R4C 7th", "R4C 8th", "R4C 9th"])                                and can_dash(state, player) and has_grapple(state, player) and (get_button_color(world, "R4C 4th") != ButtonColor.PINK or can_press_buttons(state, world, ["R4C 3rd"])) and ((get_button_color(world, "R4C 5th") == ButtonColor.GREEN and has_sword(state, player)) or can_press_buttons(state, world, ["R4C 6th"])) and (get_button_color(world, "R4C 9th") != ButtonColor.PINK or can_press_buttons(state, world, ["R4C 10th"])))
        set_button_rule(world, "R4C 10th",              lambda state: can_press_buttons(state, world, ["R4C 1st", "R4C 2nd", "R4C 4th", "R4C 5th", "R4C 7th", "R4C 8th", "R4C 10th"])                               and can_dash(state, player) and has_grapple(state, player) and (get_button_color(world, "R4C 4th") != ButtonColor.PINK or can_press_buttons(state, world, ["R4C 3rd"])) and ((get_button_color(world, "R4C 5th") == ButtonColor.GREEN and has_sword(state, player)) or can_press_buttons(state, world, ["R4C 6th"])))
        set_button_rule(world, "R4C 5 Parry 1",         lambda state: can_press_buttons(state, world, ["R4C 1st", "R4C 2nd", "R4C 4th", "R4C 5th", "R4C 7th", "R4C 8th", "R4C 9th", "R4C 5 Parry 1"])               and can_dash(state, player) and has_grapple(state, player) and (get_button_color(world, "R4C 4th") != ButtonColor.PINK or can_press_buttons(state, world, ["R4C 3rd"])) and ((get_button_color(world, "R4C 5th") == ButtonColor.GREEN and has_sword(state, player)) or can_press_buttons(state, world, ["R4C 6th"])) and (get_button_color(world, "R4C 9th") != ButtonColor.PINK or can_press_buttons(state, world, ["R4C 10th"])))
        set_button_rule(world, "R4C 5 Parry 2",         lambda state: can_press_buttons(state, world, ["R4C 1st", "R4C 2nd", "R4C 4th", "R4C 5th", "R4C 7th", "R4C 8th", "R4C 9th", "R4C 5 Parry 2"])               and can_dash(state, player) and has_grapple(state, player) and (get_button_color(world, "R4C 4th") != ButtonColor.PINK or can_press_buttons(state, world, ["R4C 3rd"])) and ((get_button_color(world, "R4C 5th") == ButtonColor.GREEN and has_sword(state, player)) or can_press_buttons(state, world, ["R4C 6th"])) and (get_button_color(world, "R4C 9th") != ButtonColor.PINK or can_press_buttons(state, world, ["R4C 10th"])))
        set_button_rule(world, "R4C 5 Parry 3",         lambda state: can_press_buttons(state, world, ["R4C 1st", "R4C 2nd", "R4C 4th", "R4C 5th", "R4C 7th", "R4C 8th", "R4C 9th", "R4C 5 Parry 3"])               and can_dash(state, player) and has_grapple(state, player) and (get_button_color(world, "R4C 4th") != ButtonColor.PINK or can_press_buttons(state, world, ["R4C 3rd"])) and ((get_button_color(world, "R4C 5th") == ButtonColor.GREEN and has_sword(state, player)) or can_press_buttons(state, world, ["R4C 6th"])) and (get_button_color(world, "R4C 9th") != ButtonColor.PINK or can_press_buttons(state, world, ["R4C 10th"])))
        ...
        set_button_rule(world, "R4E Save",              lambda state: can_press_buttons(state, world, ["R4E Save"]))
        set_button_rule(world, "R4F Lower",             lambda state: can_press_buttons(state, world, ["R4F Lower"])                                                                                                and can_dash(state, player) and has_grapple(state, player) and can_parry(state, player))
        set_button_rule(world, "R4F Save",              lambda state: can_press_buttons(state, world, ["R4F Save"]))
        set_button_rule(world, "R4G 1st",               lambda state: can_press_buttons(state, world, ["R4G 1st", "R4G 2nd"])                                                                                       and can_dash(state, player) and has_grapple(state, player) and can_parry(state, player))
        set_button_rule(world, "R4G 2nd",               lambda state: can_press_buttons(state, world, ["R4G 2nd"])                                                                                                  and can_dash(state, player) and has_grapple(state, player) and can_parry(state, player))
        set_button_rule(world, "R4G 3rd",               lambda state: can_press_buttons(state, world, ["R4G 3rd"])                                                                                                  and can_dash(state, player) and has_grapple(state, player) and can_parry(state, player))
        ...
        set_button_rule(world, "R4I Gate Upper",        lambda state: can_press_buttons(state, world, ["R4I Gate Upper"]))
        set_button_rule(world, "R4I Save",              lambda state: can_press_buttons(state, world, ["R4I Save"]))
        set_button_rule(world, "R4J Save",              lambda state: can_press_buttons(state, world, ["R4J Save"]))
        set_button_rule(world, "Dark 1",                lambda state: can_press_buttons(state, world, ["Dark 1"])                                                                                                   and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "Dark 2",                lambda state: can_press_buttons(state, world, ["Dark 1", "Dark 2"])                                                                                         and can_dash(state, player) and has_grapple(state, player) and has_sword(state, player))
        set_button_rule(world, "Dark 3",                lambda state: can_press_buttons(state, world, ["Dark 1", "Dark 2", "Dark 3"])                                                                               and can_dash(state, player) and has_grapple(state, player) and has_sword(state, player))
        set_button_rule(world, "Dark 4",                lambda state: can_press_buttons(state, world, ["Dark 1", "Dark 2", "Dark 3", "Dark 4"])                                                                     and can_dash(state, player) and has_grapple(state, player) and has_sword(state, player))
        set_button_rule(world, "Dark 5",                lambda state: can_press_buttons(state, world, ["Dark 1", "Dark 2", "Dark 3", "Dark 4", "Dark 5"])                                                           and can_dash(state, player) and has_grapple(state, player) and has_sword(state, player))
        set_button_rule(world, "Dark 6",                lambda state: can_press_buttons(state, world, ["Dark 1", "Dark 2", "Dark 3", "Dark 4", "Dark 5", "Dark 6"])                                                 and can_dash(state, player) and has_grapple(state, player) and has_sword(state, player))
        set_button_rule(world, "Dark Save",             lambda state: can_press_buttons(state, world, ["Dark Save"]))
        set_button_rule(world, "Smile Refund",          lambda state: can_press_buttons(state, world, ["Smile Refund"]))
        set_button_rule(world, "Smile Hidden",          lambda state: can_press_buttons(state, world, ["Smile Hidden"])                                                                                             and can_dash(state, player))
        set_button_rule(world, "Collapse George Rescue",lambda state: can_press_buttons(state, world, ["Collapse George Rescue"])                                                                                   and can_dash(state, player) and has_grapple(state, player))
        set_button_rule(world, "Void Chase 1",          lambda state: can_press_buttons(state, world, ["Void Chase 1"])                                                                                             and can_dash(state, player) and has_grapple(state, player) and void_gate_open(state, player))
        set_button_rule(world, "Void Chase 2",          lambda state: can_press_buttons(state, world, ["Void Chase 2"])                                                                                             and can_dash(state, player) and has_grapple(state, player) and void_gate_open(state, player))
        set_button_rule(world, "Void Chase 3",          lambda state: can_press_buttons(state, world, ["Void Chase 3"])                                                                                             and can_dash(state, player) and has_grapple(state, player) and void_gate_open(state, player))
        set_button_rule(world, "Void Chase 4",          lambda state: can_press_buttons(state, world, ["Void Chase 1", "Void Chase 2", "Void Chase 3", "Void Chase Gate", "Void Chase 4"])                          and can_dash(state, player) and has_grapple(state, player) and void_gate_open(state, player))
        set_button_rule(world, "Void Chase Gate",       lambda state: can_press_buttons(state, world, ["Void Chase Gate"])                                                                                          and can_dash(state, player) and has_grapple(state, player) and void_gate_open(state, player))
        set_button_rule(world, "Epilogue 1",            lambda state: can_press_buttons(state, world, ["Epilogue 1"])                                                                                               and can_dash(state, player))
        set_button_rule(world, "Between Save",          lambda state: can_press_buttons(state, world, ["Between Save"])                                                                                             and can_dash(state, player))
        set_button_rule(world, "Between Gate Left",     lambda state: can_press_buttons(state, world, ["Between Gate Left"])                                                                                        and can_dash(state, player))
        set_button_rule(world, "Between rm1",           lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm1"])                                                                         and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm4",           lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm4"])                                                                         and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm5",           lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm5"])                                                                         and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm10",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm10"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm13",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm13"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm19",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm19"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm28",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm28"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm30",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm30"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm39",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm39"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm40",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm40"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm42 Button 1", lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm42 Button 1"])                                                               and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm42 Button 2", lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm42 Button 2"])                                                               and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm42 Button 3", lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm42 Button 3"])                                                               and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm42 Button 4", lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm42 Button 4"])                                                               and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm42 Button 5", lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm42 Button 5"])                                                               and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm42 Button 6", lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm42 Button 6"])                                                               and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm42 Button 7", lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm42 Button 7"])                                                               and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm43 Button 1", lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm43 Button 1"])                                                               and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm43 Button 2", lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm43 Button 2"])                                                               and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm57",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm57"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm66",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm66"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between rm71",          lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between rm71"])                                                                        and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
        set_button_rule(world, "Between Pre-Boss 1",    lambda state: can_press_buttons(state, world, ["Between Gate Left", "Between Pre-Boss 1"])                                                                  and can_fight(state, world) and can_dash_attack(state, player) and has_grapple(state, player) and can_parry(state, player) and between_completion(state, world, 4))
